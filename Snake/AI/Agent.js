class SnakeAgent{
    constructor() {
        this.actions = ['a', 'w', 's', 'd', 'none']; //Conjunto de Acciones Posibles 
        this.directions = {"100":"x","-100":"-x","010":"y","0-10":"-y","001":"z","00-1":"-z"}
        this.currentCell = "b"; //La celda actual será blanca(sin importancia)
    }
    read_state(env_elements){
    	//Redondeamos al número más cerca (entero) de las posicion de la cabeza del snake  
        ...
        //Checar las posiciones peligrosas y le pasamos la posicion de la cabeza
